...
########################################################################
## For root clock nets
set CTS_NDR_RULE_NAME			"rm_2w2s_shield_default" 
set CTS_NDR_SHIELDING_LAYER_WIDTH_LIST 	"M1 0.040 M2 0.040 C1 0.044 C2 0.044 C3 0.044 C4 0.044 C5 0.044 JA 0.450" 
set CTS_NDR_SHIELDING_LAYER_SPACING_LIST "M1 0.040 M2 0.040 C1 0.046 C2 0.046 C3 0.046 C4 0.046 C5 0.046 JA 0.450" 
set CTS_NDR_MIN_ROUTING_LAYER		"M2" 
set CTS_NDR_MAX_ROUTING_LAYER		"C5" 

## For internal clock nets (by default same values as with the root clock nets)
set CTS_INTERNAL_NDR_RULE_NAME		"$CTS_NDR_RULE_NAME" 
set CTS_INTERNAL_NDR_SHIELDING_LAYER_WIDTH_LIST "$CTS_NDR_SHIELDING_LAYER_WIDTH_LIST" 
set CTS_INTERNAL_NDR_SHIELDING_LAYER_SPACING_LIST "$CTS_NDR_SHIELDING_LAYER_SPACING_LIST" 
set CTS_INTERNAL_NDR_MIN_ROUTING_LAYER "$CTS_NDR_MIN_ROUTING_LAYER" 
set CTS_INTERNAL_NDR_MAX_ROUTING_LAYER "$CTS_NDR_MAX_ROUTING_LAYER"

## For leaf clock nets
set CTS_LEAF_NDR_RULE_NAME 		"rm_leaf" 
