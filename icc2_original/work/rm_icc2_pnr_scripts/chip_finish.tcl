...
set p_pins [get_pins -of_objects [get_flat_cells -all -hierarchical ] -filter "name == VPW_P"]
connect_pg_net -net VSS   [get_pins $p_pins ]
set n_pins [get_pins -of_objects [get_flat_cells -all -hierarchical ] -filter "name == VNW_N"]
connect_pg_net -net VSS   [get_pins $n_pins ]
save_block
