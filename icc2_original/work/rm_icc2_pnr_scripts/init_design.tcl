...
set_boundary_cell_rules -left_boundary_cell {SC8T_ROWCAPANTENNALX9_CSC20L} -right_boundary_cell {SC8T_ROWCAPANTENNARX9_CSC20L} -top_boundary_cell {SC8T_COLCAPNX1_CSC20L} -bottom_boundary_cell {SC8T_COLCAPPX1_CSC20L} -bottom_right_outside_corner_cell {SC8T_CNREXTANTENNAPRX9_CSC20L} -bottom_left_outside_corner_cell {SC8T_CNREXTANTENNAPLX9_CSC20L} -top_right_outside_corner_cell {SC8T_CNREXTANTENNANRX9_CSC20L} -top_left_outside_corner_cell {SC8T_CNREXTANTENNANLX9_CSC20L} -bottom_right_inside_corner_cells {SC8T_CONCAVEPLX9_CSC20L} -bottom_left_inside_corner_cells {SC8T_CONCAVEPRX9_CSC20L} -top_right_inside_corner_cells {SC8T_CONCAVENLX9_CSC20L} -top_left_inside_corner_cells {SC8T_CONCAVENRX9_CSC20L}  -prefix ENDCAP 
...
create_tap_cells -lib_cell SC8T_TAPZBX8_CSC20L  -distance 50 -pattern every_row -skip_fixed_cells
connect_pg_net 
####################################
