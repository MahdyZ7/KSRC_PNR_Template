...
set DESIGN_NAME 		"multpool_NBITS256_PBITS0_NMUL1" 
...
set REFERENCE_LIBRARY 		[list /home/projects/vlsi/libraries/22nm/ref_libs/hvt.ndm /home/projects/vlsi/libraries/22nm/ref_libs/rvt.ndm]	;# Required; a list of reference libraries for the design library.
...
##################################################
set TECH_FILE 			"/home/projects/vlsi/libraries/22nm/tech/tf/old/tech.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
...
set VERILOG_NETLIST_FILES	"/home/projects/vlsi/Research/REF_METHODOLOGY/REFERENCE_METHODOLOGY/SYNOPSYS/ICC2/front_end/multpool.v"	;# Verilog netlist files;
					;# 	for DP: required
					;# 	for PNR: required if INIT_DESIGN_INPUT is ASCII in icc2_pnr_setup.tcl; not required for DC_ASCII or DP_RM_NDM
set TCL_MCMM_SETUP_FILE		""	;# Specify a Tcl script to create your corners, modes, scenarios and load respective constraints;
					...
					;# 	for DP: required
					;# 	for PNR: required if INIT_DESIGN_INPUT is ASCII in icc2_pnr_setup.tcl; not required for DC_ASCII or DP_RM_NDM
set TCL_PARASITIC_SETUP_FILE	"/home/projects/vlsi/Research/REF_METHODOLOGY/REFERENCE_METHODOLOGY/SYNOPSYS/ICC2/useful_scripts/read_parasitics.tcl"	;# Specify a Tcl script to read in your TLU+ files by using the read_parasitic_tech command;
...
set DEF_SITE_NAME_PAIRS			{} ;# Optional; A list of site name pairs for read_def -convert; 
...
set ENABLE_REDUNDANT_VIA_INSERTION	false ;# false|true; tool default false; optional in RM; enables redundant via insertion for post-route;
